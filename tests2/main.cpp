...
- mettre en place la vraie boucle de serveur avec poll
- tester un write (voir resultat avec curl)
- verifier comment catch les signaux pour toujours shutdown le serveur proprement
- essayer d'utiliser wireshark
- regarder le format et les infos du fichier de config
- commencer a parser une simple requete GET
